...
class AppPropertiesTest {
    ...
    void constructor_nullStockfishPath() {
        AppProperties props = new AppProperties(null, 15, 5000, 4);
    ...
    void constructor_invalidAnalysisDepth() {
        AppProperties props1 = new AppProperties("path", 0, 5000, 4);
        AppProperties props2 = new AppProperties("path", -10, 5000, 4);
    ...
    void constructor_invalidAnalysisTimeLimit() {
        AppProperties props1 = new AppProperties("path", 15, 0, 4);
        AppProperties props2 = new AppProperties("path", 15, -1000, 4);
    ...
    void constructor_invalidPoolSize() {
        AppProperties props1 = new AppProperties("path", 15, 5000, 0);
        AppProperties props2 = new AppProperties("path", 15, 5000, -5);
    ...
    void constructor_validValues() {
        AppProperties props = new AppProperties("/path/to/stockfish", 20, 10000, 8);
    ...
    void constructor_validStockfishPath() {
        ...
        AppProperties props = new AppProperties(path, 15, 5000, 4);
    ...
    void constructor_largeAnalysisDepth() {
        AppProperties props = new AppProperties("path", 100, 5000, 4);
    ...
    void constructor_largeTimeLimit() {
        AppProperties props = new AppProperties("path", 15, 60000, 4);
    ...
    void constructor_largePoolSize() {
        AppProperties props = new AppProperties("path", 15, 5000, 32);
    ...
    void constructor_allDefaults() {
        AppProperties props = new AppProperties(null, 0, 0, 0);
    ...
    void record_equality() {
        AppProperties p1 = new AppProperties("path", 15, 5000, 4);
        AppProperties p2 = new AppProperties("path", 15, 5000, 4);
    ...
    void record_inequality() {
        AppProperties p1 = new AppProperties("path1", 15, 5000, 4);
        AppProperties p2 = new AppProperties("path2", 15, 5000, 4);
    ...
    void record_toString() {
        AppProperties props = new AppProperties("mypath", 15, 5000, 4);
    ...
    void constructor_minValidDepth() {
        AppProperties props = new AppProperties("path", 1, 5000, 4);
    ...
    void constructor_minValidTimeLimit() {
        AppProperties props = new AppProperties("path", 15, 1, 4);
    ...
    void constructor_minValidPoolSize() {
        AppProperties props = new AppProperties("path", 15, 5000, 1);
